...
{
	/*
	// Declare an initialize pointer

	int* pNumber {}; // implicitly initialized with nullptr
	double* pFractionalNumber {};

	int* pNumber1 {nullptr}; // explicitly initialized with nullptr
	...
	std::cout << "sizeof(p_number1) : " << sizeof(pNumber1) << std::endl;
	std::cout << "sizeof(p_fractional_number1) : " << sizeof(pFractionalNumber1) << std::endl;
	...
	*/
	...
	std::cout << "value : " << *p_int2 << std::endl; // Dereferencing a pointer (aka getting the value)
